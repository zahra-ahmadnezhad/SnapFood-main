...
const UserComments = () => {
  return (
    <Grid p={1} borderBottom={"0.0625rem solid rgba(58, 61, 66, 0.12)"} xs={12} >

                <Grid display={"flex"} xs={12} flexDirection={{ xs: "column", sm: "row" }} alignItems={{ sm: "center" }} >
                    <Grid item xs={4} p={0.5} display={"flex"} flexDirection={{ sm: "column", xs: "row" }} justifyContent={"space-between"} >
